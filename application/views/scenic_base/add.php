...
<div class="container-fluid">
    <div class="row-fluid">
        <div class="span12">
            <h3 class="page-title">景区管理<small> 景点产品添加</small></h3>
                ...
                <div class="portlet-body form">
                    <form class="form-horizontal scenic-base-form" enctype="multipart/form-data">
                        ...
                        <div class="control-group add-pop-up-html">
                            ...
                            <div class="controls">
                                <input type="text" name="uid" class="m-wrap span8 supplieruid required" readonly="readonly" placeholder="双击选择供应商编号">
                            </div>
                        </div>
                        <div class="control-group">
