                ...
                <div class="portlet-body form">
                    <form class="form-horizontal scenic-theme-form" enctype="multipart/form-data">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="hidden" name="cat_id" value="<?php echo $scenicCat->cat_id ?>">
                                <input type="text" name="cat_name" value="<?php echo $scenicCat->cat_name ?>" class="m-wrap span8 required">
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <label class="radio">
                                    <input type="radio" name="is_show" value="1" <?php if ($scenicCat->is_show==1):?>checked="checked"<?php endif;?>> 显示
                                </label>
                                <label class="radio">
                                    <input type="radio" name="is_show" value="2" <?php if ($scenicCat->is_show==2):?>checked="checked"<?php endif;?>> 不显示
                                </label>
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="sort" value="<?php echo $scenicCat->sort ?>" class="m-wrap span8 required">
                            </div>
                        </div>
