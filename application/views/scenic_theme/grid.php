...
<div class="container-fluid">
    <div class="row-fluid">
        <div class="span12">
            <h3 class="page-title">景区管理<small> 旅游主题</small></h3>
            <?php echo breadcrumb(array('景区管理', '景区产品', '旅游主题')); ?>
        </div>
    </div>
                        ...
                        <div class="row-fluid">
                            <div class="span4">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="theme_name" value="<?php echo $this->input->get('theme_name') ?>" class="m-wrap span12" placeholder="请输入景区编号或景区名称">
                                    </div>
                                </div>
                            </div>
                            <div class="span4">
            ...
            <div class="portlet box green">
                ...
                <div class="portlet-body flip-scroll">
                    <div class="dataTables_wrapper form-inline">
                        <div class="clearfix">
                            <a href="<?php echo base_url('scenic_theme/add') ?>" class="add-button-link">
                                <div class="btn-group">
                        ...
                        <?php if ($all_rows > 0) :?>
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><input type="checkbox" class="checkboxes" value="<?php echo $item->theme_id ?>" ></td>
                                        <td><?php echo $item->theme_id;?></td>
                                        <td><?php echo $item->theme_name;?></td>
                                        <td><?php echo $isShow[$item->is_show];?></td>
                                        <td><?php echo $item->created_at;?></td>
                                        <td>
                                            <a href="<?php echo base_url('scenic_theme/edit/'.$item->theme_id) ?>" class="btn mini green">编辑</a>
                                        </td>
                                    </tr>
                                    <?php endforeach;?>
                                </tbody>
